...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <h3 className='flex items-end gap-2 text-xl md:text-2xl font-Ovo'>Hi! I'm Lakshmi Santhosh <Image src={assets.hand_icon} alt="" className='w-6'/></h3>

        <h5 className='text-xl sm:text-6xl lg:text-[40px] font-Ovo'>  <span>A Passionate -</span> <span className='text-cyan-400'><TypeWriter options={{ strings: ['Frontend Developer', 'Backend Developer', 'Web Developer'], autoStart: true, loop: true,delay:75,deleteSpeed:50}} /></span></h5>
